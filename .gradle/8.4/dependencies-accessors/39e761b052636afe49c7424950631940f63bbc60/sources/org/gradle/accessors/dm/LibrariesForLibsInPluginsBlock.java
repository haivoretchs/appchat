...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final NkzawaLibraryAccessors laccForNkzawaLibraryAccessors = new NkzawaLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at nkzawa
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public NkzawaLibraryAccessors getNkzawa() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForNkzawaLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class NkzawaLibraryAccessors extends SubDependencyFactory {
        private final NkzawaSocketLibraryAccessors laccForNkzawaSocketLibraryAccessors = new NkzawaSocketLibraryAccessors(owner);

        public NkzawaLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at nkzawa.socket
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public NkzawaSocketLibraryAccessors getSocket() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForNkzawaSocketLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class NkzawaSocketLibraryAccessors extends SubDependencyFactory {
        private final NkzawaSocketIoLibraryAccessors laccForNkzawaSocketIoLibraryAccessors = new NkzawaSocketIoLibraryAccessors(owner);

        public NkzawaSocketLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at nkzawa.socket.io
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public NkzawaSocketIoLibraryAccessors getIo() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForNkzawaSocketIoLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class NkzawaSocketIoLibraryAccessors extends SubDependencyFactory {

        public NkzawaSocketIoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for client (com.github.nkzawa:socket.io-client)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("nkzawa.socket.io.client");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: socketIoClient (2.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: socketIoClientVersion (0.6.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getSocketIoClientVersion() { return getVersion("socketIoClientVersion"); }
